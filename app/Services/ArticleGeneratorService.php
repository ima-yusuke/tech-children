...
6. **記事の構成は以下のようにしてください：**
   ...
   **1. 導入文**
   - **読者の悩み**：読者が抱えている悩みや問題を3つ程度明確に箇条書きで提示してください
   - **こういった疑問に答えます** という一文を入れてください
   - **本記事の内容**：この記事で学べることを奇数個（3つ、5つ、7つ）の箇条書きで提示してください
     ※読者の悩みに対する解決策を目次として組み込んでください
   - **結果の明示**：この記事を読むとどうなるのかを具体的に伝えてください
   - **結果の根拠**：上記で示した結果が出る根拠を伝えてください（権威、実体験、年数、実績など）
     ※「この記事を書いている私は...」という形で信頼性を示してください

   **2. 本文**
   - 各セクションは以下の順番で構成してください：
     1. 主張（何について説明するか）
     2. 理由（なぜそうなのか、3つ程度）
     3. 具体例（コード例や実例）
     4. 補足説明（つまずきやすいポイント）
   ...
   **3. 反論への理解**
   - 本文の後に、読者が持つかもしれない不安や疑問を先回りして解消してください
